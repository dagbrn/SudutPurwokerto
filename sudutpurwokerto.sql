...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2024 at 10:24 AM
...
INSERT INTO `akun` (`id_akun`, `nama_lengkap`, `email`, `username`, `password`, `role`, `foto`) VALUES
(3, 'Darrell Gibran', 'antbalnive@gmail.com', 'dgibran', '$2y$12$BGEjF/er7L95kxF7Is.pPOlaYO0v6V8ctYRdoO6MAxl6CPqssKQ.C', 'admin', '1734253403_download (4).jpg'),
(5, 'Ammar Yasin', 'gonz@gmail.com', 'gonz', '$2y$10$/p9tZAWDJjiO01PXVe397e4nzphBrIphZQ4NNUXiYKg8EP2I8JeOK', 'user', '1734253706_images (2).jpg'),
(7, 'ata', 'ata@gmail.com', 'ata', '$2y$10$vnP0vNSPA8sjcBOd4zZuluO2OrDT3ONERc6efw6BX.F4ACY1d.Ir6', 'user', '1734110156_download (2).jpg'),
(8, 'ata', 'ata@gmail.com', 'ataa', '$2y$10$wD.BAuHu3V8VYyE0UBZp6e2M0lN9Lsc7N.rAQUpcuW4XaqQXZBXru', 'user', 'pp.png'),
(9, 'Athaya Raihan Annafi', 'athaya@gmail.com', 'nfii', '$2y$10$07FU2VBrccpjTLmOmSp93O3mDHXaxDs/HE3G/J.u9QpgMqMZwJa56', 'user', 'pp.png'),
(10, 'Andi Supandi', 'andi@gmail.com', 'andi', '$2y$10$fzvKgSNlYx6cUjEklXAaAu5fC5C6SGDvjR4t.Lgd6nQRcbYap6qKq', 'user', 'pp.png'),
(11, 'Tantri Kotak', 'tatak@gmail.com', 'tantri', '$2y$10$JGVEBXZ/OjeDw6K1AdQ.OOkF4T0OILxgSWGuYReyQhOx9JJbZqiO2', 'user', 'pp.png'),
(12, 'Ratulangi', 'pahlawanratulangi@gmail.com', 'ratulangi', '$2y$10$aM15jeMOSroyz4qrf6rnueQfe3VZZ0jDUJgMCIKp4QujXanXqZoOa', 'user', '1734180997_download.jpg');
...
(8, 103, 'kuliner', 5, 'Ayam Kampungnya Top sekali!!!', '2024-12-12 23:21:50'),
(9, 2, 'wisata', 5, 'Tempatnya terlihat sangat cantik, saya akan coba ajak keluarga saya kesana. Terima kasih informasinya!!!', '2024-12-12 23:24:30'),
(10, 103, 'kuliner', 7, 'Terima kasih rekomendasinyaa!!', '2024-12-13 00:24:33'),
(11, 103, 'kuliner', 7, 'Ternyata enak sekali makanannya, terima kasih', '2024-12-13 00:33:40'),
(12, 2, 'event', 7, 'Seru sekali!!', '2024-12-13 23:23:52'),
(13, 102, 'kuliner', 12, 'Rekomendasi yang baik!', '2024-12-14 19:56:08');
